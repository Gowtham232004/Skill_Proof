...
const STEPS = [
  ...
  { n:'04', label:'Gemini AI',       icon:'◎', color:'#A78BFA', tag:'Grounded Questions',
    desc:'Gemini 1.5 Pro generates 5 questions grounded in your actual code — each references a specific file or function.',
